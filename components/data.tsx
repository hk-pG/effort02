    ...
    content: (
      <Article
        ...
        content={
          <div>
            <p>
              ei2032です。 マップとマップの謎解き担当です。
              謎解きのレベルは低いと思います。 謎解きを作ってる時不安でした。
              楽しんでくれたら嬉しいです。
              今年は去年の反省を踏まえ、モバイル部門を頑張って行きたいです。
              あ、忘れてた、松村恵杜です。
            </p>
          </div>
        }
        ...
        content={
          <div>
            <p>
              ...
              <br />
              嘘です。本人はお疲れのためサイトの製作者である私ことei2030が代弁させていただきます。
            </p>
            <p>
              今回の制作では森田君にはマップ上のイベント処理等を担当してもらいました。
              <br />
              彼は基本的に自ら分からないことを調べ、作業を進めてくれたのでとても助かりました。
              <br />
              また、結果的に私自身が苦手な分野を補ってもらう形になったことから、今回の制作にとって欠かせない人物だったと感じています。
            </p>
          </div>
        }
      />
